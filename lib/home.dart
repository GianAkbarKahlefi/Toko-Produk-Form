...
class HomeState extends State<Home> {
  late Future<List<ProdukModel>>
      produkList; // Ubah dari SiswaModel ke ProdukModel
  ...
  Future<List<ProdukModel>> getProdukList() async {
    final response = await http.get(Uri.parse(
        "http://127.0.0.1/produkk/list.php")); // Ganti dengan endpoint produk
        ...
        flexibleSpace: Container(
          decoration: BoxDecoration(
            gradient: LinearGradient(
              colors: [Colors.purple, Colors.purple], // Gradient background
            ...
            if (snapshot.connectionState == ConnectionState.waiting) {
              ...
              return Center(
                  child: Text('No data found',
                      style: TextStyle(
                          fontSize: 18,
                          color: Colors.grey))); // Handle empty data
            }
                  ...
                  child: ListTile(
                    ...
                    subtitle: Text(
                      ...
                      style: TextStyle(
                        ...
                        fontStyle:
                            FontStyle.italic, // Subtle emphasis on category
                      ),
                    ),
                    onTap: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => Detail(product: data)));
                    },
                  ),
                );
              },
